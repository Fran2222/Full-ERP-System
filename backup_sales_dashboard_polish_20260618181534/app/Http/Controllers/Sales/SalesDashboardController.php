...
class SalesDashboardController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $branchSalesPerformance = $this->branchSalesPerformance($periodFrom, $periodTo);
    ...
    {
        return $user && method_exists($user, 'hasAnyRole') && $user->hasAnyRole([
            'BOD', 'Board of Directors', 'bod', 'Super Admin', 'Super Administrator', 'super-admin',
        ]);
    }
    ...
    private function branchSalesPerformance(Carbon $from, Carbon $to)
    {
