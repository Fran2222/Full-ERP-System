        ...
        <div class="card rounded-4 border-0 shadow-sm">
            <div class="card-header bg-white border-0 rounded-top-4 px-4 pt-4 pb-2">
                <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
                    <div>
                        <h4 class="card-title mb-1 fw-bold">Add Customer</h4>
                        <p class="text-secondary mb-0">
                            Create a customer record for sales transactions.
                        </p>
                    </div>
            ...
            <div class="card-body px-4 pb-4">
                ...
                <form method="POST" action="{{ route('sales.customers.store') }}">
                    ...
                    @include('sales.customers.form')

                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <a href="{{ route('sales.customers.index') }}" class="btn btn-outline-secondary px-4">
                            Cancel
                        </a>
