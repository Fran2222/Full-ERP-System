        ...
        <div class="card sales-form-panel">
            <div class="card-header bg-white border-0 rounded-top-4 px-4 pt-4 pb-2">
                <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
                    <div>
                        <h4 class="card-title mb-1 fw-bold">New Invoice</h4>
                        <p class="text-secondary mb-0">
                            Create a customer invoice with item lines, due date, and receivable balance.
                        </p>
                    </div>

                    <a href="{{ route('sales.invoices.index') }}" class="btn btn-outline-secondary sales-soft-btn">
                        Back
                    </a>
                </div>
            </div>
            ...
            <div class="card-body px-4 pb-4">
                ...
                <form method="POST" action="{{ route('sales.invoices.store') }}" id="invoiceForm">
                    ...
                    <div class="d-flex flex-wrap justify-content-end gap-2 mt-4">
                        <a href="{{ route('sales.invoices.index') }}" class="btn btn-outline-secondary px-4 sales-soft-btn">
                            Cancel
                        </a>
