        ...
        <div class="card rounded-4 border-0 shadow-sm">
            <div class="card-header bg-white border-0 rounded-top-4 px-4 pt-4 pb-2">
                <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
                    <div>
                        <h4 class="card-title mb-1 fw-bold">Add Item</h4>
                        <p class="text-secondary mb-0">
                            Create a new warehouse item master record.
                        </p>
                    </div>
            ...
            <div class="card-body px-4 pb-4">
                ...
                <form method="POST" enctype="multipart/form-data" action="{{ route('warehouse.items.store') }}">
                    @csrf
