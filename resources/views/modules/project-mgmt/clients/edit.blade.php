    ...
    <div class="container-fluid content-inner mt-n5 py-0">
        <div class="card rounded-4">
            <div class="card-header">
                ...
                <p class="text-secondary mb-0">Update client information.</p>
            </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('clients.update', $client->id) }}" method="POST" class="row g-3 needs-validation" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="remarks"
                                  ...
                                  rows="3"
                                  maxlength="1000"
                                  placeholder="Add remarks or client notes">{{ old('remarks', $client->remarks) }}</textarea>
                        <div class="invalid-feedback">
                            @error('remarks')
                                {{ $message }}
                            @else
