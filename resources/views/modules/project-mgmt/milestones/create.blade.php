    ...
    <div class="container-fluid content-inner mt-n5 py-0">
        <div class="card rounded-4">
            <div class="card-header">
                <h4 class="card-title mb-0">Create Milestone</h4>
                <p class="text-secondary mb-0">Add a project phase with percentage weight.</p>
            </div>
            ...
            <div class="card-body">
                ...
                @php
                    ...
                    $selectedTeamIds = collect(old('team_ids', []))->map(fn ($id) => (string) $id)->toArray();
                ...
                <form action="{{ route('project-milestones.store') }}" method="POST" class="row g-3 needs-validation milestone-form" novalidate>
                    @csrf
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control bg-light text-muted" value="Pending" disabled>
                    </div>
      ...
      <script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                document.querySelectorAll('.milestone-date-group').forEach(function (group) {
                    group.addEventListener('click', function (event) {
                        if (event.target.closest('.invalid-feedback')) return;

                        const targetId = group.getAttribute('data-picker-target');
                        const input = document.getElementById(targetId);
