        ...
        <div class="col-12">
            <div class="card rounded-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="card-title mb-1">Edit Project</h4>
                        <p class="mb-0 text-muted">{{ $project->code ?? 'Project' }} - Update project information.</p>
                    </div>

                    <a href="{{ route('projects.show', $project->id) }}" class="btn btn-outline-primary btn-sm">Back</a>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('projects.update', $project->id) }}" method="POST" class="row g-3 needs-validation" novalidate>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input type="number"
                                       ...
                                       value="{{ old('amount', $project->amount !== null ? number_format((float) $project->amount, 2, '.', '') : '') }}"
                        ...
                        <div class="col-md-6">
                            ...
                            @php
                                $clientSelectedValue = old('client_id', $project->client_id);
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="priority_id" class="form-select searchable-select @error('priority_id') is-invalid @enderror" required>
                                ...
                                @foreach ($priorities as $priority)
                                    <option value="{{ $priority->id }}" {{ old('priority_id', $project->priority_id) == $priority->id ? 'selected' : '' }}>
                                        {{ $priority->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            @php
                                $autoStatusLabel = optional($project->projectStatus)->name ?? ucfirst($project->status ?? 'Pending');
                                $autoProgress = (int) ($project->progress_percent ?? 0);
                            @endphp
                            <div class="form-control wmc-readonly-manager text-muted">
                                {{ $autoStatusLabel }} / {{ $autoProgress }}%
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            @php
                                $branchSelectedValue = old('branch_id', $project->branch_id);
                        ...
                        <div class="col-md-6">
                            ...
                            @php
                                $departmentSelectedValue = old('department_id', $project->department_id);
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="location" class="form-control @error('location') is-invalid @enderror" value="{{ old('location', $project->location) }}" maxlength="180">
                            ...
                            <div class="input-group has-validation">
                                <span class="input-group-text">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" style="display:block;">
                                        <path d="M7 2V5M17 2V5M3 9H21M5 5H19C20.1046 5 21 5.89543 21 7V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V7C3 5.89543 3 5 5 5Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </span>
                                <input type="text" id="start_date" name="start_date" class="form-control date_flatpicker @error('start_date') is-invalid @enderror" placeholder="Select Start Date" value="{{ old('start_date', $formatDate($project->start_date ?? null)) }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input type="text" id="target_end_date" name="target_end_date" class="form-control date_flatpicker @error('target_end_date') is-invalid @enderror" placeholder="Select Target End Date" value="{{ old('target_end_date', $formatDate($project->target_end_date ?? $project->end_date ?? null)) }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input type="text" id="actual_end_date" name="actual_end_date" class="form-control date_flatpicker @error('actual_end_date') is-invalid @enderror" placeholder="Select Actual End Date" value="{{ old('actual_end_date', $formatDate($project->actual_end_date ?? null)) }}">
                                <div class="invalid-feedback">@error('actual_end_date') {{ $message }} @else Actual end date must be valid. @enderror</div>
                            </div>
                        </div>

                        <div class="col-12">
                            <label class="form-label">Description</label>
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="4" maxlength="1000">{{ old('description', $project->description) }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            @php
                                $selectedUserIds = old('users', $project->users->pluck('id')->toArray());
                    ...
                    flatpickr('#start_date', {
                        ...
                        onChange: function (selectedDates) {
                            if (selectedDates.length) {
                                if (targetEndPicker) targetEndPicker.set('minDate', selectedDates[0]);
                                if (actualEndPicker) actualEndPicker.set('minDate', selectedDates[0]);
                            }
                        }
                    });

                    targetEndPicker = flatpickr('#target_end_date', {
                        dateFormat: 'Y-m-d',
                        allowInput: true,
                        minDate: document.querySelector('#start_date')?.value || null
                    });

                    actualEndPicker = flatpickr('#actual_end_date', {
                        dateFormat: 'Y-m-d',
                        allowInput: true,
                        minDate: document.querySelector('#start_date')?.value || null
                    });
