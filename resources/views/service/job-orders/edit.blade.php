...
<style>
    ...
    <div class="mb-3"><h3 class="mb-1">Edit Service Job Order</h3><p class="text-muted mb-0">{{ $jobOrder->job_order_no }} - {{ $jobOrder->subject }}</p></div>
    ...
    <form method="POST" action="{{ route('service.job-orders.update', $jobOrder) }}">@method('PUT') @include('service.job-orders._form', ['buttonText' => 'Update Job Order'])</form>
</x-app-layout>
