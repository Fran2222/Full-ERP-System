        ...
        <div class="card rounded-4 border-0 shadow-sm accounting-card">
            <div class="card-header bg-white border-0 rounded-top-4 px-4 pt-4 pb-2">
                <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
                    <div>
                        <h4 class="card-title mb-1 fw-bold">Edit Account</h4>
                        <p class="text-secondary mb-0">
                            Update account code, name, type, and status.
                        </p>
                    </div>
            ...
            <div class="card-body px-4 pb-4">
                ...
                <form method="POST" action="{{ route('accounting.accounts.update', $account) }}">
                    ...
                    @include('accounting.accounts.form')

                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <a href="{{ route('accounting.accounts.index') }}" class="btn btn-outline-secondary px-4">
                            Cancel
                        </a>
