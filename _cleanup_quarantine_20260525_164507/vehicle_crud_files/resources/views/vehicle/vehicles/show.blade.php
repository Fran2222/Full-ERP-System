...
<div class="container-fluid py-4">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('vehicle-management.vehicles') }}" class="btn btn-light">Back</a>
            <a href="{{ route('vehicle-management.vehicles.edit', $vehicle) }}" class="btn btn-primary">Edit Vehicle</a>
        </div>
    </div>
