...
<div class="container-fluid py-4">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
        ...
        <a href="{{ route('vehicle-management.vehicles.create') }}" class="btn btn-primary">
            Add Vehicle
        </a>
    </div>
        ...
        <div class="card-body">
            <form method="GET" class="row g-2 align-items-end mb-3">
                ...
                <div class="col-lg-3 d-flex gap-2">
                    ...
                    <a href="{{ route('vehicle-management.vehicles') }}" class="btn btn-light">Reset</a>
                </div>
            </form>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        @endif
                                        <div>
                                            <a href="{{ route('vehicle-management.vehicles.show', $vehicle) }}" class="fw-semibold text-primary">
                                ...
                                <td class="text-end">
                                    <div class="d-inline-flex gap-1">
                                        <a href="{{ route('vehicle-management.vehicles.show', $vehicle) }}" class="btn btn-sm btn-outline-secondary">View</a>
                                        <a href="{{ route('vehicle-management.vehicles.edit', $vehicle) }}" class="btn btn-sm btn-outline-primary">Edit</a>
                                        <form action="{{ route('vehicle-management.vehicles.destroy', $vehicle) }}" method="POST" onsubmit="return confirm('Archive this vehicle?');">
                                            @csrf
                                            @method('DELETE')
