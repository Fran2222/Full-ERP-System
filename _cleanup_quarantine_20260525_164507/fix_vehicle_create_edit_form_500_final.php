<?php
// fix_vehicle_create_edit_form_500_final.php
// Fixes BOTH:
//   /vehicle-management/vehicles/create
//   /vehicle-management/vehicles/{id}/edit
//
// Cause from Laravel log:
// syntax error, unexpected token "=", expecting ")" in resources/views/vehicle/vehicles/_form.blade.php
//
// This replaces ONLY the broken partial:
// resources/views/vehicle/vehicles/_form.blade.php
//
// No database changes.

$root = __DIR__;
$file = $root . DIRECTORY_SEPARATOR . 'resources' . DIRECTORY_SEPARATOR . 'views' . DIRECTORY_SEPARATOR . 'vehicle' . DIRECTORY_SEPARATOR . 'vehicles' . DIRECTORY_SEPARATOR . '_form.blade.php';

echo "============================================================\n";
echo "Vehicle Create/Edit _form.blade.php 500 Final Fix\n";
echo "============================================================\n\n";
...
$backup = $file . '.backup-before-final-form-500-fix-' . date('YmdHis');
copy($file, $backup);
...
echo "Compiled views cleared by script.\n\n";
