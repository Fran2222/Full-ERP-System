...
class VehicleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('vehicle.vehicles.index', [
            ...
            'fuelTypes' => $this->fuelTypesForDropdown(),
    ...
    public function update(Request $request, Vehicle $vehicle)
    {
        ...
        return redirect()
            ->route('vehicle.vehicles.show', $vehicle)
    ...
    protected function fuelTypesForDropdown()
    {
        if (class_exists(VehicleFuelType::class) && Schema::hasTable('vehicle_fuel_types')) {
            $query = VehicleFuelType::query();

            if (Schema::hasColumn('vehicle_fuel_types', 'status')) {
                $query->where(function ($q) {
                    $q->where('status', 'active')->orWhereNull('status');
                });
            }

            if (Schema::hasColumn('vehicle_fuel_types', 'is_active')) {
                $query->where(function ($q) {
